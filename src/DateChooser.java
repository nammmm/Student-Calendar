...
public class DateChooser extends JPanel {
		...
		showDate.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent me) {
				if (showDate.isEnabled()) {
					...
					showDate.setForeground(Color.LIGHT_GRAY);
				}
			}
	...
	private class JP1 extends JPanel {
		...
		private void initJP1() {
			...
			yearleft.setFont(new Font("Segoe UI", Font.PLAIN, 14));
			yearleft.setToolTipText("Previous year");
			yearright = new JLabel(">>  ", JLabel.CENTER);
			yearright.setFont(new Font("Segoe UI", Font.PLAIN, 14));
			...
			monthleft.setFont(new Font("Segoe UI", Font.PLAIN, 14));
			monthleft.setToolTipText("Previous month");
			monthright = new JLabel(">  ", JLabel.LEFT);
			monthright.setFont(new Font("Segoe UI", Font.PLAIN, 14));
			...
			centercontainer.setFont(new Font("Segoe UI", Font.PLAIN, 14));
			...
			yearleft.addMouseListener(new MouseAdapter() {
				public void mouseEntered(MouseEvent me) {
					...
					yearleft.setForeground(Color.LIGHT_GRAY);
				}
			...
			yearright.addMouseListener(new MouseAdapter() {
				public void mouseEntered(MouseEvent me) {
					...
					yearright.setForeground(Color.LIGHT_GRAY);
				}
			...
			monthleft.addMouseListener(new MouseAdapter() {
				public void mouseEntered(MouseEvent me) {
					...
					monthleft.setForeground(Color.LIGHT_GRAY);
				}
			...
			monthright.addMouseListener(new MouseAdapter() {
				public void mouseEntered(MouseEvent me) {
					...
					monthright.setForeground(Color.LIGHT_GRAY);
				}
	...
	private class JP2 extends JPanel {
		...
		protected void paintComponent(Graphics g) {
			g.setFont(font);
			g.drawString("Sun    Mon    Tue    Wed     Thu     Fri       Sat", 8, 13);
	...
	private class JP4 extends JPanel {
		...
		public JP4() {
			...
			jl.setToolTipText("Click to choose date");
	...
	public static void main(String[] args) {
		...
		JFrame jf = new JFrame("Date Chooser");
